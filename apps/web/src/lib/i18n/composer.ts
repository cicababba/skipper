...
const en = {
  ...
  create: "Create",
  creating: "Creating…",
  createdN: (ref: string) => `${ref} created`,
  createFailed: "Creation failed",
  retry: "Retry",
  openIssue: "Open on the tracker",
  allCreated: "Every issue was created.",
  toastCreated: (ref: string) => `Issue ${ref} created`,
