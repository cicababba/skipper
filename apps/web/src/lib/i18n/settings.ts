...
const en = {
  ...
  orchestration: {
    ...
    runtimes: "Runtimes",
    runtimesDesc:
      "Which agent CLI each role runs on. Codex, Copilot and Gemini run on their own configured models — the model rows above apply to the Claude runtime. Switching the coder's runtime mid-issue restarts the run with a recap of the work already done instead of resuming.",
    runtimeDefault: "Default runtime",
    runtimeClaude: "Claude Code",
    runtimeCodex: "Codex",
    runtimeCopilot: "Copilot",
    runtimeGemini: "Gemini",
    plannerRuntime: "Planner",
    plannerRuntimeDesc: "Runtime for planning, plan chat and confidence scoring.",
    coderRuntime: "Coder",
    coderRuntimeDesc: "Runtime for the coding run in the worktree.",
    reviewerRuntime: "Reviewer",
    reviewerRuntimeDesc: "Runtime for the diff review.",
    on: "On",
    off: "Off",
...
const it: typeof en = {
  ...
  orchestration: {
    ...
    runtimes: "Runtime",
    runtimesDesc:
      "Quale CLI agente usa ogni ruolo. Codex, Copilot e Gemini usano il modello configurato al loro interno — le righe dei modelli qui sopra valgono per il runtime Claude. Cambiare il runtime del coder a metà issue fa ripartire il run con un riepilogo del lavoro già fatto invece di riprenderlo.",
    runtimeDefault: "Runtime predefinito",
    runtimeClaude: "Claude Code",
    runtimeCodex: "Codex",
    runtimeCopilot: "Copilot",
    runtimeGemini: "Gemini",
    plannerRuntime: "Planner",
    plannerRuntimeDesc: "Runtime per la pianificazione, la chat sul piano e la confidenza.",
    coderRuntime: "Coder",
    coderRuntimeDesc: "Runtime per il run di sviluppo nel worktree.",
    reviewerRuntime: "Reviewer",
    reviewerRuntimeDesc: "Runtime per la review del diff.",
    on: "Attivo",
    off: "Disattivo",
...
const fr: typeof en = {
  ...
  orchestration: {
    ...
    runtimes: "Runtimes",
    runtimesDesc:
      "Quel CLI agent chaque rôle utilise. Codex, Copilot et Gemini tournent sur leur propre modèle configuré — les lignes de modèles ci-dessus concernent le runtime Claude. Changer le runtime du coder en cours d'issue relance le run avec un récapitulatif du travail déjà fait au lieu de le reprendre.",
    runtimeDefault: "Runtime par défaut",
    runtimeClaude: "Claude Code",
    runtimeCodex: "Codex",
    runtimeCopilot: "Copilot",
    runtimeGemini: "Gemini",
    plannerRuntime: "Planner",
    plannerRuntimeDesc: "Runtime pour la planification, le chat de plan et la confiance.",
    coderRuntime: "Coder",
    coderRuntimeDesc: "Runtime pour le run de codage dans le worktree.",
    reviewerRuntime: "Reviewer",
    reviewerRuntimeDesc: "Runtime pour la revue du diff.",
    on: "Activé",
    off: "Désactivé",
...
const es: typeof en = {
  ...
  orchestration: {
    ...
    runtimes: "Runtimes",
    runtimesDesc:
      "Qué CLI de agente usa cada rol. Codex, Copilot y Gemini usan su propio modelo configurado — las filas de modelos de arriba aplican al runtime de Claude. Cambiar el runtime del coder a mitad de la issue reinicia la ejecución con un resumen del trabajo ya hecho en vez de reanudarla.",
    runtimeDefault: "Runtime predeterminado",
    runtimeClaude: "Claude Code",
    runtimeCodex: "Codex",
    runtimeCopilot: "Copilot",
    runtimeGemini: "Gemini",
    plannerRuntime: "Planner",
    plannerRuntimeDesc: "Runtime para la planificación, el chat del plan y la confianza.",
    coderRuntime: "Coder",
    coderRuntimeDesc: "Runtime para la ejecución de código en el worktree.",
    reviewerRuntime: "Reviewer",
    reviewerRuntimeDesc: "Runtime para la revisión del diff.",
    on: "Activada",
    off: "Desactivada",
