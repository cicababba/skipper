...
const en = {
  ...
  llm: {
    ...
    model: "Model",
    latest: "latest",
    authHintBefore: (cli: string) => `Authenticated via your ${cli} CLI session. Run`,
    authHintAfterTerminal: "in a terminal if needed.",
    authHintAfterCopilot: "and type /login inside it if needed.",
    authHintAfterGemini: "— it opens browser sign-in on first launch.",
    alsoSupports: (clis: string) => `Skipper also works with ${clis} — install to select here.`,
    apiKey: "API Key",
    test: "Test",
  ...
  account: {
    ...
    clientIdPlaceholder: "Client ID from your instance",
    clientIdHelp: "Register a public OAuth application on your instance (Administration → Authentication → OAuth applications) and paste its Client ID here.",
    generic: {
    ...
    byProvider: {
      ...
      jira: {
        title: "Jira",
        freeTitle: "Jira sign-in is not available in source builds",
        freeDesc: "The Jira OAuth app comes pre-configured in the official builds. Building from source? Wire your own Atlassian OAuth 2.0 (3LO) app — see the README.",
        signIn: "Connect Jira",
        signedOutTitle: "Connect a Jira account",
        signedOutDesc: "Connect Jira Cloud, or sign in to a Data Center instance with a personal access token.",
        signOut: "Disconnect",
      },
      bitbucket: {
        title: "Bitbucket",
        freeTitle: "Bitbucket sign-in is not available in source builds",
        freeDesc: "The Bitbucket OAuth consumer comes pre-configured in the official builds. Building from source? Wire your own Bitbucket Cloud consumer — see the README.",
        signIn: "Connect Bitbucket",
        signedOutTitle: "Connect a Bitbucket account",
        signedOutDesc: "Connect Bitbucket Cloud so the orchestrator can shepherd pull requests on its repositories.",
        signOut: "Disconnect",
      },
      openproject: {
        title: "OpenProject",
        freeTitle: "OpenProject sign-in is not available in source builds",
        freeDesc: "OpenProject is self-hosted — register your own OAuth application or use an API key. See the README.",
        signIn: "Connect OpenProject",
        signedOutTitle: "Connect an OpenProject account",
        signedOutDesc: "Connect your OpenProject instance so assigned work packages flow into the inbox and through the orchestrator.",
        signOut: "Disconnect",
      },
  ...
  orchestration: {
    ...
    agents: "Agents",
    agentsDesc:
      "Each role runs on an agent CLI and a model; non-Claude CLIs default to their own configured model. A repo can override any of these pairs. Switching the coder's CLI mid-issue restarts the run with a recap of the work already done instead of resuming.",
    agentDefault: "Default agent",
    agentDefaultDesc: "The agent every role uses unless it has one of its own.",
    agentUseDefault: "Use default",
    planner: "Planner",
    plannerDesc: "Plans the work, chats about the plan and scores its confidence.",
    coder: "Coder",
    coderDesc: "Writes the code in the worktree.",
    reviewer: "Reviewer",
    reviewerDesc: "Reviews the diff before it reaches you.",
    composer: "Composer",
    composerDesc: "Explores the repo with you in the chat composer and drafts the issues.",
    runtimeClaude: "Claude Code",
    runtimeCodex: "Codex",
    runtimeCopilot: "Copilot",
    runtimeGemini: "Gemini",
    runtimeNotInstalled: (label: string) => `${label} (not installed)`,
    noRuntimesInstalled:
  ...
  repositories: {
    ...
    mapping: {
      ...
      desc: "Tracker projects have no repository of their own. Map each project to the repo its issues should code against.",
...
const it: typeof en = {
  ...
  llm: {
    ...
    model: "Modello",
    latest: "ultimo",
    authHintBefore: (cli: string) => `Autenticato tramite la tua sessione ${cli} CLI. Se necessario, esegui`,
    authHintAfterTerminal: "in un terminale.",
    authHintAfterCopilot: "e digita /login al suo interno.",
    authHintAfterGemini: "— apre l'accesso dal browser al primo avvio.",
    alsoSupports: (clis: string) => `Skipper funziona anche con ${clis} — installa per selezionarli qui.`,
    apiKey: "API Key",
    test: "Prova",
  ...
  account: {
    ...
    clientIdLabel: "Client ID OAuth",
    clientIdPlaceholder: "Client ID della tua istanza",
    clientIdHelp: "Registra un'applicazione OAuth pubblica sulla tua istanza (Amministrazione → Autenticazione → Applicazioni OAuth) e incolla qui il suo Client ID.",
    generic: {
    ...
    byProvider: {
      ...
      jira: {
        title: "Jira",
        freeTitle: "L'accesso Jira non è disponibile nelle build da sorgente",
        freeDesc: "L'app OAuth Jira è preconfigurata nelle build ufficiali. Compili da sorgente? Collega la tua app Atlassian OAuth 2.0 (3LO) — vedi il README.",
        signIn: "Collega Jira",
        signedOutTitle: "Collega un account Jira",
        signedOutDesc: "Collega Jira Cloud, oppure accedi a un'istanza Data Center con un token di accesso personale.",
        signOut: "Disconnetti",
      },
      bitbucket: {
        title: "Bitbucket",
        freeTitle: "L'accesso Bitbucket non è disponibile nelle build da sorgente",
        freeDesc: "Il consumer OAuth Bitbucket è preconfigurato nelle build ufficiali. Compili da sorgente? Collega il tuo consumer Bitbucket Cloud — vedi il README.",
        signIn: "Collega Bitbucket",
        signedOutTitle: "Collega un account Bitbucket",
        signedOutDesc: "Collega Bitbucket Cloud così l'orchestratore può gestire le pull request sui suoi repository.",
        signOut: "Disconnetti",
      },
      openproject: {
        title: "OpenProject",
        freeTitle: "L'accesso OpenProject non è disponibile nelle build da sorgente",
        freeDesc: "OpenProject è self-hosted — registra la tua applicazione OAuth oppure usa una API key. Vedi il README.",
        signIn: "Collega OpenProject",
        signedOutTitle: "Collega un account OpenProject",
        signedOutDesc: "Collega la tua istanza OpenProject così i work package assegnati entrano nell'inbox e nell'orchestratore.",
        signOut: "Disconnetti",
      },
    },
  },
  ...
  orchestration: {
    ...
    agents: "Agent",
    agentsDesc:
      "Ogni ruolo gira su una CLI agente e su un modello; le CLI non-Claude usano il modello configurato al loro interno. Ogni repo può sovrascrivere queste coppie. Cambiare la CLI del coder a metà issue fa ripartire il run con un riepilogo del lavoro già fatto invece di riprenderlo.",
    agentDefault: "Agent predefinito",
    agentDefaultDesc: "L'agent usato da ogni ruolo che non ne ha uno suo.",
    agentUseDefault: "Usa predefinito",
    planner: "Planner",
    plannerDesc: "Pianifica il lavoro, ne discute il piano e ne valuta la confidenza.",
    coder: "Coder",
    coderDesc: "Scrive il codice nel worktree.",
    reviewer: "Reviewer",
    reviewerDesc: "Rivede il diff prima che arrivi a te.",
    composer: "Composer",
    composerDesc: "Esplora il repo con te nella chat e redige le issue.",
    runtimeClaude: "Claude Code",
    runtimeCodex: "Codex",
    runtimeCopilot: "Copilot",
    runtimeGemini: "Gemini",
    runtimeNotInstalled: (label: string) => `${label} (non installato)`,
    noRuntimesInstalled:
      "Nessuna CLI agente trovata. Installa Claude Code, Codex, Copilot o Gemini CLI e riavvia Skipper.",
    modelCliDefault: "Predefinito della CLI",
    modelOpus: "Claude Opus",
    modelSonnet: "Claude Sonnet",
    modelHaiku: "Claude Haiku",
    modelFable: "Claude Fable",
    modelCustom: "Personalizzato…",
    modelCustomPlaceholder: "id del modello",
    on: "Attivo",
    off: "Disattivo",
  ...
  repositories: {
    ...
    mapping: {
      ...
      desc: "I progetti dei tracker non hanno un repository proprio. Associa ogni progetto al repo su cui le sue issue devono lavorare.",
...
const fr: typeof en = {
  ...
  llm: {
    ...
    model: "Modèle",
    latest: "dernier",
    authHintBefore: (cli: string) => `Authentifié via votre session ${cli} CLI. Si besoin, exécutez`,
    authHintAfterTerminal: "dans un terminal.",
    authHintAfterCopilot: "puis tapez /login à l'intérieur.",
    authHintAfterGemini: "— la connexion s'ouvre dans le navigateur au premier lancement.",
    alsoSupports: (clis: string) => `Skipper fonctionne aussi avec ${clis} — installez pour les sélectionner ici.`,
    apiKey: "Clé API",
    test: "Tester",
  ...
  account: {
    ...
    clientIdLabel: "Client ID OAuth",
    clientIdPlaceholder: "Client ID de votre instance",
    clientIdHelp: "Enregistrez une application OAuth publique sur votre instance (Administration → Authentification → Applications OAuth) et collez son Client ID ici.",
    generic: {
    ...
    byProvider: {
      ...
      jira: {
        title: "Jira",
        freeTitle: "La connexion Jira n'est pas disponible dans les builds depuis les sources",
        freeDesc: "L'app OAuth Jira est préconfigurée dans les builds officiels. Vous compilez depuis les sources ? Branchez votre propre app Atlassian OAuth 2.0 (3LO) — voir le README.",
        signIn: "Connecter Jira",
        signedOutTitle: "Connecter un compte Jira",
        signedOutDesc: "Connectez Jira Cloud, ou connectez-vous à une instance Data Center avec un jeton d'accès personnel.",
        signOut: "Déconnecter",
      },
      bitbucket: {
        title: "Bitbucket",
        freeTitle: "La connexion Bitbucket n'est pas disponible dans les builds depuis les sources",
        freeDesc: "Le consumer OAuth Bitbucket est préconfiguré dans les builds officiels. Vous compilez depuis les sources ? Branchez votre propre consumer Bitbucket Cloud — voir le README.",
        signIn: "Connecter Bitbucket",
        signedOutTitle: "Connecter un compte Bitbucket",
        signedOutDesc: "Connectez Bitbucket Cloud pour que l'orchestrateur gère les pull requests sur ses dépôts.",
        signOut: "Déconnecter",
      },
      openproject: {
        title: "OpenProject",
        freeTitle: "La connexion OpenProject n'est pas disponible dans les builds depuis les sources",
        freeDesc: "OpenProject est auto-hébergé — enregistrez votre propre application OAuth ou utilisez une clé API. Voir le README.",
        signIn: "Connecter OpenProject",
        signedOutTitle: "Connecter un compte OpenProject",
        signedOutDesc: "Connectez votre instance OpenProject pour que les lots de travaux assignés arrivent dans la boîte de réception et passent par l'orchestrateur.",
        signOut: "Déconnecter",
      },
    },
  },
  ...
  orchestration: {
    ...
    agents: "Agents",
    agentsDesc:
      "Chaque rôle s'exécute sur une CLI d'agent et un modèle ; les CLI non-Claude utilisent le modèle configuré de leur côté. Chaque dépôt peut remplacer ces paires. Changer la CLI du coder en cours d'issue relance le run avec un récapitulatif du travail déjà fait au lieu de le reprendre.",
    agentDefault: "Agent par défaut",
    agentDefaultDesc: "L'agent utilisé par chaque rôle qui n'en a pas un à lui.",
    agentUseDefault: "Utiliser par défaut",
    planner: "Planner",
    plannerDesc: "Planifie le travail, discute du plan et évalue sa confiance.",
    coder: "Coder",
    coderDesc: "Écrit le code dans le worktree.",
    reviewer: "Reviewer",
    reviewerDesc: "Revoit le diff avant qu'il ne vous parvienne.",
    composer: "Composer",
    composerDesc: "Explore le dépôt avec vous dans le chat et rédige les issues.",
    runtimeClaude: "Claude Code",
    runtimeCodex: "Codex",
    runtimeCopilot: "Copilot",
    runtimeGemini: "Gemini",
    runtimeNotInstalled: (label: string) => `${label} (non installé)`,
    noRuntimesInstalled:
      "Aucune CLI d'agent trouvée. Installez Claude Code, Codex, Copilot ou Gemini CLI puis redémarrez Skipper.",
    modelCliDefault: "Défaut de la CLI",
    modelOpus: "Claude Opus",
    modelSonnet: "Claude Sonnet",
    modelHaiku: "Claude Haiku",
    modelFable: "Claude Fable",
    modelCustom: "Personnalisé…",
    modelCustomPlaceholder: "id du modèle",
    on: "Activé",
    off: "Désactivé",
  ...
  repositories: {
    ...
    mapping: {
      ...
      desc: "Les projets des trackers n'ont pas de dépôt propre. Associez chaque projet au dépôt sur lequel ses issues doivent coder.",
...
const es: typeof en = {
  ...
  llm: {
    ...
    model: "Modelo",
    latest: "último",
    authHintBefore: (cli: string) => `Autenticado mediante tu sesión de ${cli} CLI. Si es necesario, ejecuta`,
    authHintAfterTerminal: "en una terminal.",
    authHintAfterCopilot: "y escribe /login dentro.",
    authHintAfterGemini: "— abre el inicio de sesión en el navegador la primera vez.",
    alsoSupports: (clis: string) => `Skipper también funciona con ${clis} — instala para seleccionarlos aquí.`,
    apiKey: "Clave de API",
    test: "Probar",
  ...
  account: {
    ...
    clientIdLabel: "Client ID de OAuth",
    clientIdPlaceholder: "Client ID de tu instancia",
    clientIdHelp: "Registra una aplicación OAuth pública en tu instancia (Administración → Autenticación → Aplicaciones OAuth) y pega aquí su Client ID.",
    generic: {
    ...
    byProvider: {
      ...
      jira: {
        title: "Jira",
        freeTitle: "El inicio de sesión con Jira no está disponible en las builds desde el código fuente",
        freeDesc: "La app OAuth de Jira viene preconfigurada en las builds oficiales. ¿Compilas desde el código fuente? Conecta tu propia app de Atlassian OAuth 2.0 (3LO) — consulta el README.",
        signIn: "Conectar Jira",
        signedOutTitle: "Conecta una cuenta de Jira",
        signedOutDesc: "Conecta Jira Cloud, o inicia sesión en una instancia Data Center con un token de acceso personal.",
        signOut: "Desconectar",
      },
      bitbucket: {
        title: "Bitbucket",
        freeTitle: "El inicio de sesión con Bitbucket no está disponible en las builds desde el código fuente",
        freeDesc: "El consumer OAuth de Bitbucket viene preconfigurado en las builds oficiales. ¿Compilas desde el código fuente? Conecta tu propio consumer de Bitbucket Cloud — consulta el README.",
        signIn: "Conectar Bitbucket",
        signedOutTitle: "Conecta una cuenta de Bitbucket",
        signedOutDesc: "Conecta Bitbucket Cloud para que el orquestador gestione las pull requests en sus repositorios.",
        signOut: "Desconectar",
      },
      openproject: {
        title: "OpenProject",
        freeTitle: "El inicio de sesión con OpenProject no está disponible en las builds desde el código fuente",
        freeDesc: "OpenProject es autoalojado — registra tu propia aplicación OAuth o usa una clave de API. Consulta el README.",
        signIn: "Conectar OpenProject",
        signedOutTitle: "Conecta una cuenta de OpenProject",
        signedOutDesc: "Conecta tu instancia de OpenProject para que los paquetes de trabajo asignados lleguen a la bandeja y pasen por el orquestador.",
        signOut: "Desconectar",
      },
    },
  },
  ...
  orchestration: {
    ...
    agents: "Agentes",
    agentsDesc:
      "Cada rol se ejecuta en una CLI de agente y un modelo; las CLI que no son de Claude usan el modelo configurado en ellas. Cada repo puede sobrescribir estos pares. Cambiar la CLI del coder a mitad de la issue reinicia la ejecución con un resumen del trabajo ya hecho en vez de reanudarla.",
    agentDefault: "Agente predeterminado",
    agentDefaultDesc: "El agente que usa cada rol que no tiene uno propio.",
    agentUseDefault: "Usar predeterminado",
    planner: "Planner",
    plannerDesc: "Planifica el trabajo, conversa sobre el plan y puntúa su confianza.",
    coder: "Coder",
    coderDesc: "Escribe el código en el worktree.",
    reviewer: "Reviewer",
    reviewerDesc: "Revisa el diff antes de que llegue a ti.",
    composer: "Composer",
    composerDesc: "Explora el repo contigo en el chat y redacta las issues.",
    runtimeClaude: "Claude Code",
    runtimeCodex: "Codex",
    runtimeCopilot: "Copilot",
    runtimeGemini: "Gemini",
    runtimeNotInstalled: (label: string) => `${label} (no instalado)`,
    noRuntimesInstalled:
      "No se encontró ninguna CLI de agente. Instala Claude Code, Codex, Copilot o Gemini CLI y reinicia Skipper.",
    modelCliDefault: "Predeterminado de la CLI",
    modelOpus: "Claude Opus",
    modelSonnet: "Claude Sonnet",
    modelHaiku: "Claude Haiku",
    modelFable: "Claude Fable",
  ...
  repositories: {
    ...
    mapping: {
      ...
      desc: "Los proyectos de los trackers no tienen repositorio propio. Asigna cada proyecto al repo sobre el que deben trabajar sus issues.",
