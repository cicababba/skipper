...
const en = {
  repos: {
    ...
    notLinkedTitle: "Followed, but with no local clone — link one to plan or code on it.",
    addTitle: "Follow a repo by name",
    addPlaceholder: "owner/name",
    addAction: "Follow",
    addInvalid: "Type the repo as owner/name.",
    link: "Link",
    clone: "Clone",
    unlink: "Unlink",
  ...
  // Orchestrator event toasts (#286): raised app-wide when an item transitions
  // into a state that wants a human.
  toasts: {
    planGate: "Plan ready for review",
    humanReview: "Changes ready for review",
    prOpened: "PR opened",
    ...
    ciFailed: "CI failed",
    merged: "PR merged",
    withConfidence: (label: string, pct: string) => `${label} · confidence ${pct}`,
    withReason: (label: string, reason: string) => `${label} — ${reason}`,
    openItem: "Open item",
    viewPr: "View PR",
  },
  states: {
  ...
  popover: {
    ...
    criteria: { verifiable: "verifiable", partial: "partly verifiable", vague: "vague" },
    ambiguities: "Left open by the issue",
    silentAssumption: "decided silently",
    flagged: "flagged",
    repoKnowledge: "question(s) answerable from the repo",
    body: "Description",
  ...
  chat: {
    ...
    activitySteps: (n: number) => `Agent activity · ${n} step${n === 1 ? "" : "s"}`,
    ...
    attachTooLarge: "File is too large (max 10 MB)",
    attachInvalidType: "Unsupported file type",
    attachLimit: "At most 4 files per message",
    removeAttachment: "Remove attachment",
    emptyPlanTitle: "Discuss this plan",
    emptyCoderTitle: "Discuss these changes",
    emptyReviewerTitle: "Discuss this review",
  },
  overview: {
    issueBody: "Issue",
    timeline: "Timeline",
  ...
  repoPage: {
    ...
    memory: {
      ...
      staleBadge: "Stale",
      staleTooltip: (pct: number, when: string) =>
        `${pct}% of the touched files no longer exist on the base branch · checked ${when}`,
      reviewQueue: "Prune candidates",
      reviewQueueCount: (n: number) => `Prune candidates (${n})`,
      reviewEmpty: "Nothing to review.",
      keep: "Keep",
      keepHint: "Keep this memory — it stops being a prune candidate for 90 days.",
      reasonNegative: "Voted down",
      reasonUnused: "Never used",
      reasonStale: "Files gone",
    },
  },
};
...
const it: typeof en = {
  repos: {
    ...
    notLinkedTitle: "Seguito, ma senza clone locale — collegane uno per pianificare o programmare.",
    addTitle: "Segui un repo per nome",
    addPlaceholder: "owner/nome",
    addAction: "Segui",
    addInvalid: "Scrivi il repo come owner/nome.",
    link: "Collega",
    clone: "Clona",
    unlink: "Scollega",
  ...
  toasts: {
    planGate: "Piano pronto da rivedere",
    humanReview: "Modifiche pronte da rivedere",
    prOpened: "PR aperta",
    prUpdated: "PR aggiornata",
    needsInput: "Serve il tuo input",
    changesRequested: "Modifiche richieste",
    ciFailed: "CI rossa",
    merged: "PR mergiata",
    withConfidence: (label, pct) => `${label} · confidence ${pct}`,
    withReason: (label, reason) => `${label} — ${reason}`,
    openItem: "Apri la issue",
    viewPr: "Vedi la PR",
  },
  states: {
    triage: "Triage",
  ...
  popover: {
    ...
    criteria: {
      verifiable: "verificabili",
      partial: "in parte verificabili",
      vague: "vaghi",
    },
    ambiguities: "Lasciato aperto dalla issue",
    silentAssumption: "deciso in silenzio",
    flagged: "segnalato",
    repoKnowledge: "domanda/e con risposta già nel repo",
    body: "Descrizione",
  ...
  chat: {
    ...
    copied: "Copiato",
    jumpToLatest: "Vai agli ultimi",
    activitySteps: (n: number) => `Attività dell'agente · ${n} pass${n === 1 ? "o" : "i"}`,
    enterHint: "Invio per inviare · Maiusc+Invio per andare a capo",
    attachmentsWarning:
      "Il runtime agente selezionato potrebbe non essere in grado di leggere questo tipo di file — potrebbe essere ignorato.",
    attachFailed: "Impossibile allegare il file",
    attachTooLarge: "File troppo grande (max 10 MB)",
    attachInvalidType: "Tipo di file non supportato",
    attachLimit: "Al massimo 4 file per messaggio",
    removeAttachment: "Rimuovi allegato",
    emptyPlanTitle: "Discuti questo piano",
    emptyCoderTitle: "Discuti queste modifiche",
    emptyReviewerTitle: "Discuti questa review",
  },
  overview: {
    issueBody: "Issue",
    timeline: "Cronologia",
  ...
  repoPage: {
    ...
    memory: {
      ...
      staleBadge: "Obsoleta",
      staleTooltip: (pct, when) =>
        `Il ${pct}% dei file toccati non esiste più sul branch di base · verificato ${when}`,
      reviewQueue: "Candidati alla potatura",
      reviewQueueCount: (n) => `Candidati alla potatura (${n})`,
      reviewEmpty: "Niente da rivedere.",
      keep: "Conserva",
      keepHint: "Conserva questa memoria — non sarà più candidata alla potatura per 90 giorni.",
      reasonNegative: "Votata giù",
      reasonUnused: "Mai usata",
      reasonStale: "File spariti",
    },
  },
};
...
const fr: typeof en = {
  repos: {
    ...
    notLinked: "non lié",
    notLinkedTitle: "Suivi, mais sans clone local — liez-en un pour planifier ou coder.",
    addTitle: "Suivre un dépôt par son nom",
    addPlaceholder: "owner/nom",
    addAction: "Suivre",
    addInvalid: "Écrivez le dépôt sous la forme owner/nom.",
    link: "Lier",
    clone: "Cloner",
    unlink: "Délier",
  ...
  toasts: {
    planGate: "Plan prêt à relire",
    humanReview: "Changements prêts à relire",
    prOpened: "PR ouverte",
    prUpdated: "PR mise à jour",
    needsInput: "Votre input est requis",
    changesRequested: "Changements demandés",
    ciFailed: "CI rouge",
    merged: "PR fusionnée",
    withConfidence: (label, pct) => `${label} · confiance ${pct}`,
    withReason: (label, reason) => `${label} — ${reason}`,
    openItem: "Ouvrir l'issue",
    viewPr: "Voir la PR",
  },
  states: {
    triage: "Triage",
  ...
  popover: {
    ...
    criteria: {
      verifiable: "vérifiables",
      partial: "en partie vérifiables",
      vague: "vagues",
    },
    ambiguities: "Laissé ouvert par l'issue",
    silentAssumption: "décidé en silence",
    flagged: "signalé",
    repoKnowledge: "question(s) dont la réponse est déjà dans le repo",
    body: "Description",
  ...
  chat: {
    ...
    copied: "Copié",
    jumpToLatest: "Aller aux derniers",
    activitySteps: (n: number) => `Activité de l'agent · ${n} étape${n === 1 ? "" : "s"}`,
    enterHint: "Entrée pour envoyer · Maj+Entrée pour un saut de ligne",
    attachmentsWarning:
      "Le runtime d'agent sélectionné pourrait ne pas savoir lire ce type de fichier — il pourrait être ignoré.",
    attachFailed: "Impossible de joindre le fichier",
    attachTooLarge: "Fichier trop volumineux (max 10 Mo)",
    attachInvalidType: "Type de fichier non pris en charge",
    attachLimit: "4 fichiers maximum par message",
    removeAttachment: "Retirer la pièce jointe",
    emptyPlanTitle: "Discuter de ce plan",
    emptyCoderTitle: "Discuter de ces changements",
    emptyReviewerTitle: "Discuter de cette review",
  },
  overview: {
    issueBody: "Issue",
  ...
  repoPage: {
    ...
    memory: {
      ...
      staleBadge: "Obsolète",
      staleTooltip: (pct, when) =>
        `${pct}% des fichiers touchés n'existent plus sur la branche de base · vérifié ${when}`,
      reviewQueue: "Candidats à l'élagage",
      reviewQueueCount: (n) => `Candidats à l'élagage (${n})`,
      reviewEmpty: "Rien à revoir.",
      keep: "Conserver",
      keepHint: "Conserver cette mémoire — elle n'est plus candidate à l'élagage pendant 90 jours.",
      reasonNegative: "Votée négativement",
      reasonUnused: "Jamais utilisée",
      reasonStale: "Fichiers disparus",
    },
  },
};
...
const es: typeof en = {
  repos: {
    ...
    notLinkedTitle: "Seguido, pero sin clon local — vincula uno para planificar o programar.",
    addTitle: "Seguir un repo por nombre",
    addPlaceholder: "owner/nombre",
    addAction: "Seguir",
    addInvalid: "Escribe el repo como owner/nombre.",
    link: "Vincular",
    clone: "Clonar",
    unlink: "Desvincular",
  ...
  toasts: {
    planGate: "Plan listo para revisar",
    humanReview: "Cambios listos para revisar",
    prOpened: "PR abierta",
    prUpdated: "PR actualizada",
    needsInput: "Necesita tu input",
    changesRequested: "Cambios solicitados",
    ciFailed: "CI en rojo",
    merged: "PR fusionada",
    withConfidence: (label, pct) => `${label} · confianza ${pct}`,
    withReason: (label, reason) => `${label} — ${reason}`,
    openItem: "Abrir la issue",
    viewPr: "Ver la PR",
  },
  states: {
    triage: "Triaje",
  ...
  popover: {
    ...
    criteria: {
      ...
      partial: "en parte verificables",
      vague: "vagos",
    },
    ambiguities: "Dejado abierto por la issue",
    silentAssumption: "decidido en silencio",
    flagged: "señalado",
    repoKnowledge: "pregunta(s) con respuesta ya en el repo",
    body: "Descripción",
  ...
  chat: {
    ...
    activitySteps: (n: number) => `Actividad del agente · ${n} paso${n === 1 ? "" : "s"}`,
    enterHint: "Intro para enviar · Mayús+Intro para nueva línea",
    attachmentsWarning:
      "Puede que el runtime de agente seleccionado no sea capaz de leer este tipo de archivo — podría ignorarlo.",
    attachFailed: "No se pudo adjuntar el archivo",
    attachTooLarge: "El archivo es demasiado grande (máx. 10 MB)",
    attachInvalidType: "Tipo de archivo no admitido",
    attachLimit: "Máximo 4 archivos por mensaje",
    removeAttachment: "Quitar adjunto",
    emptyPlanTitle: "Discute este plan",
    emptyCoderTitle: "Discute estos cambios",
    emptyReviewerTitle: "Discute esta review",
  },
  overview: {
    issueBody: "Issue",
    timeline: "Cronología",
  ...
  repoPage: {
    ...
    memory: {
      ...
      staleBadge: "Obsoleta",
      staleTooltip: (pct, when) =>
        `El ${pct}% de los archivos tocados ya no existe en la rama base · verificado ${when}`,
      reviewQueue: "Candidatas a poda",
      reviewQueueCount: (n) => `Candidatas a poda (${n})`,
      reviewEmpty: "Nada que revisar.",
      keep: "Conservar",
      keepHint: "Conserva esta memoria — deja de ser candidata a poda durante 90 días.",
      reasonNegative: "Votada en contra",
      reasonUnused: "Nunca usada",
      reasonStale: "Archivos desaparecidos",
    },
  },
};
