...
const en = {
  ...
  repoPage: {
    ...
    instructions: {
      ...
      desc: "Conventions Skipper gives the planner and coder for this repo. Seeded from CLAUDE.md or generated; your edits are kept.",
...
const it: typeof en = {
  ...
  repoPage: {
    ...
    instructions: {
      ...
      desc: "Convenzioni che Skipper passa a planner e coder per questo repo. Ricavate da CLAUDE.md o generate; le tue modifiche restano.",
...
const fr: typeof en = {
  ...
  repoPage: {
    ...
    instructions: {
      ...
      desc: "Conventions que Skipper transmet au planner et au coder pour ce dépôt. Issues de CLAUDE.md ou générées ; vos modifications sont conservées.",
...
const es: typeof en = {
  ...
  repoPage: {
    ...
    instructions: {
      ...
      desc: "Convenciones que Skipper pasa al planner y al coder para este repo. Tomadas de CLAUDE.md o generadas; tus ediciones se conservan.",
