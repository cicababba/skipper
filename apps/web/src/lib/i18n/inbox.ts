...
const en = {
  ...
  repoPage: {
    ...
    instructions: {
      ...
      desc: "Conventions Skipper gives the planner and coder for this repo. Seeded from the repo's agent instructions (CLAUDE.md, AGENTS.md or copilot-instructions) or generated; your edits are kept.",
...
const it: typeof en = {
  ...
  repoPage: {
    ...
    instructions: {
      ...
      desc: "Convenzioni che Skipper passa a planner e coder per questo repo. Ricavate dalle istruzioni agent del repo (CLAUDE.md, AGENTS.md o copilot-instructions) o generate; le tue modifiche restano.",
...
const fr: typeof en = {
  ...
  repoPage: {
    ...
    instructions: {
      ...
      desc: "Conventions que Skipper transmet au planner et au coder pour ce dépôt. Issues des instructions agent du dépôt (CLAUDE.md, AGENTS.md ou copilot-instructions) ou générées ; vos modifications sont conservées.",
...
const es: typeof en = {
  ...
  repoPage: {
    ...
    instructions: {
      ...
      desc: "Convenciones que Skipper pasa al planner y al coder para este repo. Tomadas de las instrucciones de agente del repo (CLAUDE.md, AGENTS.md o copilot-instructions) o generadas; tus ediciones se conservan.",
